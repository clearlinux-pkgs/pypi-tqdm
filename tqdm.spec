...
Source0  : https://files.pythonhosted.org/packages/06/ca/721a7abe555012efaa4d6ee18a0048a4f27d84c6220bb6aa6eba049117d6/tqdm-4.61.0.tar.gz
...
%prep
%setup -q -n tqdm-4.61.0
cd %{_builddir}/tqdm-4.61.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621958902
...
cp %{_builddir}/tqdm-4.61.0/LICENCE %{buildroot}/usr/share/package-licenses/tqdm/b4d93a527c38de0e53b77ab0b5011b4cff72c285
