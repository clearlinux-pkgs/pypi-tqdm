...
%prep
%setup -q -n tqdm-4.61.1
cd %{_builddir}/tqdm-4.61.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623687885
...
cp %{_builddir}/tqdm-4.61.1/LICENCE %{buildroot}/usr/share/package-licenses/tqdm/b4d93a527c38de0e53b77ab0b5011b4cff72c285
