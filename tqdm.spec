...
Source0  : https://files.pythonhosted.org/packages/0d/dd/78f7e080d3bfc87fc19bed54513b430659d38efb2d9ea6e3ad815a665a02/tqdm-4.61.2.tar.gz
...
%prep
%setup -q -n tqdm-4.61.2
cd %{_builddir}/tqdm-4.61.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625591405
...
cp %{_builddir}/tqdm-4.61.2/LICENCE %{buildroot}/usr/share/package-licenses/tqdm/b4d93a527c38de0e53b77ab0b5011b4cff72c285
