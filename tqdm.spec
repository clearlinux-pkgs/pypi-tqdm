...
Source0  : https://files.pythonhosted.org/packages/35/35/bd5af89c97ad5177ed234d9e79d01a984f8b5226b8ffc8b5d3c4fc8e157d/tqdm-4.60.0.tar.gz
...
%prep
%setup -q -n tqdm-4.60.0
cd %{_builddir}/tqdm-4.60.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617728531
...
cp %{_builddir}/tqdm-4.60.0/LICENCE %{buildroot}/usr/share/package-licenses/tqdm/b4d93a527c38de0e53b77ab0b5011b4cff72c285
