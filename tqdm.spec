...
Source0  : https://files.pythonhosted.org/packages/37/e5/1b54ef934d731576d0145bc8ae22da5b410f96922cec52b91cc29d3ff1b6/tqdm-4.62.2.tar.gz
...
%prep
%setup -q -n tqdm-4.62.2
cd %{_builddir}/tqdm-4.62.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629744599
...
cp %{_builddir}/tqdm-4.62.2/LICENCE %{buildroot}/usr/share/package-licenses/tqdm/b4d93a527c38de0e53b77ab0b5011b4cff72c285
