...
Source0  : https://files.pythonhosted.org/packages/9f/7b/76c4e5ef1a1b528fcaada4133f972e77d33c252831676cf414119ca6093d/tqdm-4.50.0.tar.gz
Source1  : https://files.pythonhosted.org/packages/9f/7b/76c4e5ef1a1b528fcaada4133f972e77d33c252831676cf414119ca6093d/tqdm-4.50.0.tar.gz.asc
...
%prep
%setup -q -n tqdm-4.50.0
cd %{_builddir}/tqdm-4.50.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601318050
...
cp %{_builddir}/tqdm-4.50.0/LICENCE %{buildroot}/usr/share/package-licenses/tqdm/db1e38a8e85ca5af92d182028bced0a1edc37e10
