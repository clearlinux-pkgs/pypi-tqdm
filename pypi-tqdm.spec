...
Source0  : https://files.pythonhosted.org/packages/cb/a5/803a55cae355bc2402492c6a1c23dc08117844e4a1c3a293b0ea19bca6fa/tqdm-4.63.0.tar.gz
...
%prep
%setup -q -n tqdm-4.63.0
cd %{_builddir}/tqdm-4.63.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646064907
...
cp %{_builddir}/tqdm-4.63.0/LICENCE %{buildroot}/usr/share/package-licenses/pypi-tqdm/d710b33bdae7b273ee64376f2e7c722e098079e9
