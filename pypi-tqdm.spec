...
Source0  : https://files.pythonhosted.org/packages/e8/4f/0153c21dc5779a49a0598c445b1978126b1344bab9ee71e53e44877e14e0/tqdm-4.67.0.tar.gz
...
%prep
%setup -q -n tqdm-4.67.0
cd %{_builddir}/tqdm-4.67.0
pushd ..
cp -a tqdm-4.67.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730930885
