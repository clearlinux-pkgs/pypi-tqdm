...
Source0  : https://files.pythonhosted.org/packages/5a/c0/b7599d6e13fe0844b0cda01b9aaef9a0e87dbb10b06e4ee255d3fa1c79a2/tqdm-4.66.4.tar.gz
...
%prep
%setup -q -n tqdm-4.66.4
cd %{_builddir}/tqdm-4.66.4
pushd ..
cp -a tqdm-4.66.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714751184
