...
Source0  : https://files.pythonhosted.org/packages/e9/34/bef135b27fe1864993a5284ad001157ee9b5538e859ac90f5b0e8cc8c9ec/tqdm-4.66.6.tar.gz
...
%prep
%setup -q -n tqdm-4.66.6
cd %{_builddir}/tqdm-4.66.6
pushd ..
cp -a tqdm-4.66.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730124657
...
cp %{_builddir}/tqdm-%{version}/LICENCE %{buildroot}/usr/share/package-licenses/pypi-tqdm/e57d6584a1725967f048ad09a13b0326ffbea02e || :
...
/usr/share/package-licenses/pypi-tqdm/e57d6584a1725967f048ad09a13b0326ffbea02e
