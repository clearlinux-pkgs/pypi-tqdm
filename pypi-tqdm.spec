...
Source0  : https://files.pythonhosted.org/packages/ea/85/3ce0f9f7d3f596e7ea57f4e5ce8c18cb44e4a9daa58ddb46ee0d13d6bff8/tqdm-4.66.2.tar.gz
...
%prep
%setup -q -n tqdm-4.66.2
cd %{_builddir}/tqdm-4.66.2
pushd ..
cp -a tqdm-4.66.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707669464
